...
class VendorOperationsSeeder extends Seeder
{
    public function run(): void
    {
        $vendors = collect([
            [
                'name' => 'Ulaanbaatar Transfer Co.',
                'vendor_code' => 'VDR-ULN001',
                'contact_person' => 'Batbayar Dorj',
                'email' => 'ops@ulaanbaatartransfer.example',
                'phone' => '+976-9911-1001',
                'line_id' => 'ulaanbaatartransfer',
                'service_type' => 'car',
            ...
            [
                'name' => 'Steppe Tour Partners',
                'vendor_code' => 'VDR-STEP02',
                'contact_person' => 'Oyun Erdene',
                'email' => 'dispatch@steppetour.example',
                'phone' => '+976-9922-9002',
                'line_id' => 'steppetour',
                'service_type' => 'tour',
            ...
            [
                'name' => 'Mongol Mobility Group',
                'vendor_code' => 'VDR-MONG03',
                'contact_person' => 'Ganbold Tsend',
                'email' => 'team@mongolmobility.example',
                'phone' => '+976-9933-4503',
                'line_id' => 'mongolmobility',
                'service_type' => 'both',
