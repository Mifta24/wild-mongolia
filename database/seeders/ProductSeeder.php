    ...
    public function run(): void
    {
        ...
        $cars = [
            [
                ...
                'max_luggage' => 2,
                'base_price' => 100000,
                'distance_price_per_km' => 2200,
                'minimum_distance_price' => 90000,
                'is_active' => true,
                'is_featured' => true,
                'total_reviews' => 450,
                'average_rating' => 4.8,
            ...
            [
                ...
                'max_luggage' => 2,
                'base_price' => 180000,
                'distance_price_per_km' => 3500,
                'minimum_distance_price' => 150000,
                'is_active' => true,
                'is_featured' => false,
                'total_reviews' => 320,
                'average_rating' => 4.9,
            ...
            [
                ...
                'max_luggage' => 4,
                'base_price' => 250000,
                'distance_price_per_km' => 4200,
                'minimum_distance_price' => 220000,
                'is_active' => true,
                'is_featured' => false,
                'total_reviews' => 280,
                'average_rating' => 4.7,
        ...
        $cars = array_map(function (array $car) {
            return array_merge([
                ...
                'add_ons' => [
                    ['name' => 'Child Seat', 'price' => 20000, 'description' => 'Per seat, subject to availability'],
                    ['name' => 'Extended Waiting (30 min)', 'price' => 30000, 'description' => 'For airport pickup delay'],
                    ['name' => 'Extra Stop', 'price' => 25000, 'description' => 'One stop on route'],
                ],
                ...
                'meeting_point_address' => 'Chinggis Khaan International Airport, Arrivals Hall',
                'meeting_point_lat' => 47.6469000,
                'meeting_point_lng' => 106.8197000,
            ], $car);
        }, $cars);
        ...
        $tours = array_map(function (array $tour) {
            return array_merge([
                ...
                'add_ons' => [
                    ['name' => 'Hotel Pickup Upgrade', 'price' => 35000, 'description' => 'Round-trip transfer from central area'],
                    ['name' => 'Professional Photo Set', 'price' => 50000, 'description' => '10 edited photos'],
                ],
