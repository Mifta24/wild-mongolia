<x-layouts.admin.app>
    <div class="mb-6">
        <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Edit Vendor</h1>
    </div>
    ...
    <form action="{{ route('admin.vendors.update', $vendor) }}" method="POST"
        ...
        @csrf
        @method('PUT')
        @include('admin.vendors.partials.form-fields', ['vendor' => $vendor])

        <div class="flex items-center gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
            <button type="submit" class="px-4 py-2 bg-teal-600 hover:bg-teal-700 text-white font-medium rounded-lg transition">Update</button>
